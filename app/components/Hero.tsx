...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1400px] px-6 pt-20 pb-24 md:px-10 md:pt-28 md:pb-40">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-2">
            <p className="font-mono-cap text-muted">
              <span className="text-accent">§&nbsp;00</span>
              <span className="ml-3 hidden md:block md:ml-0 md:mt-2">
                Frontispiece
              </span>
            </p>
          </div>
          ...
          <div className="col-span-12 md:col-span-10">
            <p className="max-w-xl animate-ink-rise font-mono-cap text-muted [animation-delay:0.05s]">
              Senior Data Scientist · Mathematician · Tel&nbsp;Aviv ↔ Guangdong
            </p>

            <h1 className="mt-8 max-w-[14ch] animate-ink-rise font-display text-[clamp(3.4rem,11vw,11rem)] leading-[0.92] text-ink [animation-delay:0.15s]">
              A mathematician,
            ...
            <div className="mt-12 grid grid-cols-1 gap-10 md:mt-16 md:grid-cols-12 md:gap-12">
              <p className="col-span-1 max-w-prose animate-ink-rise text-lg leading-relaxed text-ink-soft md:col-span-7 md:text-xl [animation-delay:0.35s]">
              ...
              <aside className="col-span-1 animate-ink-rise space-y-5 border-l border-rule pl-6 md:col-span-4 md:col-start-9 [animation-delay:0.55s]">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 flex justify-between border-t border-rule/60 bg-paper/70 px-6 py-3 font-mono-cap text-muted backdrop-blur-sm md:px-10">
        <span>scroll · §&nbsp;01</span>
...
function Stat({ k, v }: { k: string; v: string }) {
  return (
    <div className="flex flex-col gap-1">
      ...
      <dd className="font-display text-2xl text-ink">{v}</dd>
    </div>
  );
}
